...
const JOB_SKILLS = {
  warrior: [
    { id: "guard", type: "active", name: "防御", description: "被ダメージを軽減する" },
    { id: "cover", type: "passive", name: "かばう", description: "大きなダメージから味方をかばう" },
    { id: "provoke", type: "active", name: "挑発", description: "敵の狙いを引きつける" },
    { id: "ironWall", type: "passive", name: "鉄壁", description: "大きく被ダメージを軽減する" },
    { id: "desperateStrike", type: "active", name: "捨て身", description: "危険を承知で強く攻撃する" },
    { id: "counter", type: "passive", name: "反撃", description: "攻撃を受けた時、反撃することがある" },
  ],
  priest: [
    { id: "heal", type: "active", name: "ヒール", description: "傷ついた味方を回復する" },
    { id: "middleHeal", type: "active", name: "ミドルヒール", description: "大きく傷ついた味方を回復する" },
    { id: "healRain", type: "active", name: "ヒールレイン", description: "味方全員を少し回復する" },
    { id: "prayer", type: "active", name: "状態回復", description: "味方の悪い状態を治療する" },
    { id: "magicBarrier", type: "active", name: "魔力障壁", description: "味方への被ダメージを軽減する" },
    { id: "divineGrace", type: "passive", name: "神の加護", description: "倒れそうな時に踏みとどまる" },
    { id: "resurrect", type: "active", name: "リザレクト", description: "倒れた味方を蘇生する。派遣中一度だけ使える" },
    { id: "resura", type: "active", name: "リザラ", description: "倒れた味方を復活させることがある" },
  ],
  mage: [
    ...
    { id: "magicSense", type: "passive", name: "魔力探知", description: "魔力の流れを読み取り、危険や異変を察知することがある" },
  ],
  scout: [
...
const SKILL_DEBUG_INFO = {
  ...
  prayer: ["対象:毒", "対象:猛毒", "対象:火傷", "対象:スロー", "対象:麻痺"],
...
const MONSTERS = {
  ...
  skeleton: { id: "skeleton", name: "骸骨兵", hp: 38, atk: 12, xp: 24, gold: 20, drops: ["rustyAxe"] },
  stoneGuard: { id: "stoneGuard", name: "石の番兵", hp: 48, atk: 13, xp: 30, gold: 26, drops: ["crackedRing"] },
