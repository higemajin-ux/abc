...
const MONSTERS = {
  ...
  sealedBeast: { id: "sealedBeast", name: "封室の獣", hp: 92, atk: 19, xp: 74, gold: 86, rare: true, boss: true, special: "stoneEcho", traitsText: "封じられた部屋の奥で目を覚ました獣。石を震わせる咆哮を放つ。", drops: ["blackIronSword", "oldBreastplate"] },
