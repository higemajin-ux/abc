...
const JOB_SKILLS = {
  ...
  priest: [
    ...
    { id: "prayer", name: "祈り", description: "味方の状態を安定させる" },
    { id: "magicBarrier", name: "魔力障壁", description: "味方への被ダメージを軽減する" },
    { id: "divineGrace", name: "神の加護", description: "倒れそうな時に踏みとどまる" },
    { id: "resurrect", name: "リザレクト", description: "倒れた味方を確実に復活させる" },
    { id: "resura", name: "リザラ", description: "倒れた味方を復活させることがある" },
  ],
  mage: [
    { id: "firebolt", name: "火球", description: "魔法で敵にダメージを与える" },
    { id: "lightning", name: "雷撃", description: "雷で敵に大きなダメージを与える" },
    { id: "iceLance", name: "氷槍", description: "氷で敵を攻撃し、鈍らせることがある" },
    { id: "acidMist", name: "アシッドミスト", description: "敵を攻撃し、毒にすることがある" },
  ...
  scout: [
    ...
    { id: "firstAid", name: "応急手当", description: "危険な味方に一時HPを付与する" },
