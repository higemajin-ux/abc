...
const JOB_SKILLS = {
  ...
  mage: [
    ...
    { id: "focus", type: "active", name: "集中", description: "魔力を高めて威力を上げる" },
  ...
  scout: [
    ...
    { id: "focus", type: "active", name: "集中", description: "攻撃の会心率を高める" },
