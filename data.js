...
const JOB_SKILLS = {
  warrior: [
    ...
    { id: "counter", name: "反撃", description: "攻撃を受けた時、反撃することがある" },
  ],
  priest: [
    { id: "heal", name: "ヒール", description: "傷ついた味方を回復する" },
    { id: "middleHeal", name: "ミドルヒール", description: "大きく傷ついた味方を回復する" },
    { id: "healRain", name: "ヒールレイン", description: "味方全員を少し回復する" },
    { id: "prayer", name: "状態回復", description: "味方の悪い状態を治療する" },
    { id: "magicBarrier", name: "魔力障壁", description: "味方への被ダメージを軽減する" },
    { id: "divineGrace", name: "神の加護", description: "倒れそうな時に踏みとどまる" },
    { id: "resurrect", name: "リザレクト", description: "倒れた味方を蘇生する。派遣中一度だけ使える" },
    { id: "resura", name: "リザラ", description: "倒れた味方を復活させることがある" },
  ],
  mage: [
    { id: "firebolt", name: "火球", description: "炎で敵を攻撃し、火傷にすることがある" },
    { id: "lightning", name: "雷撃", description: "雷で敵を攻撃し、麻痺にすることがある" },
    { id: "iceLance", name: "氷槍", description: "氷で敵を攻撃し、スローにすることがある" },
    { id: "acidMist", name: "アシッドミスト", description: "酸の霧で敵を攻撃し、毒や猛毒にすることがある" },
    { id: "focus", name: "集中", description: "魔力を高めて威力を上げる" },
    { id: "magicSense", name: "魔力探知", description: "魔力の流れを読み取り、危険や異変を察知することがある" },
  ],
  scout: [
    { id: "ambush", name: "奇襲", description: "敵より先に動き、不意打ちを仕掛けることがある" },
    { id: "focus", name: "集中", description: "攻撃の会心率を高める" },
    { id: "blind", name: "目つぶし", description: "敵の攻撃を外れやすくする" },
    { id: "firstAid", name: "応急手当", description: "味方に一時的なバリアを与える" },
    { id: "treasureFind", name: "宝箱発見", description: "探索中に宝箱を見つけることがある" },
    { id: "trapDisarm", name: "罠解除", description: "探索中に罠を解除することがある" },
    { id: "shortcutFind", name: "近道発見", description: "探索中に近道を見つけることがある" },
  ],
};
...
const SKILL_DEBUG_INFO = {
  ...
  focus: ["発動:35%", "持続:2ターン", "会心率:+25%", "魔法集中:30%", "魔法威力:1.5倍"],
  magicSense: ["発動率:20%", "条件:魔法使いが生存", "条件:ボス以外", "条件:エリアにモンスター候補あり"],
