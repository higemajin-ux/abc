...
const AREAS = {
  ...
  plainEntrance: {
    ...
    unlockAfter: null,
    description: "村の外れに広がる浅い草地。新人冒険者の足慣らしに使われる。",
    treasureRates: [0.7, 0.5, 0.25, 0.12],
  ...
  plainRoad: {
    ...
    description: "古い石畳が残る街道沿い。草むらの奥に、小さな足跡が増え始めている。",
    treasureRates: [0.7, 0.5, 0.25, 0.12],
    trapRates: [0.25, 0.15, 0.1, 0.05],
  ...
  goblinNest: {
    ...
    description: "平原の奥に作られた粗末な巣。ゴブリンたちが集まり、武器を持つ個体も見られる。",
    treasureRates: [0.7, 0.5, 0.25, 0.12],
    trapRates: [0.25, 0.15, 0.1, 0.05],
  ...
  howlingRoad: {
    ...
    normalEncounterGroupWeights: { 1: 75, 2: 20, 3: 5 },
    unlockAfter: "goblinNest",
    description: "森の入口に続く薄暗い道。月明かりの下、遠くから獣の声が聞こえる。",
  ...
  mossTrail: {
    ...
    description: "湿った苔に覆われた獣道。足跡は奥へ向かい、森の気配は少しずつ濃くなる。",
  ...
  beastTerritory: {
    ...
    description: "森の深部に広がる静かな縄張り。木々の間には、大きな獣が通った跡が残っている。",
